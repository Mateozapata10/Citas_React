...
const Formulario = ({pacientes, setPacientes, paciente, setPaciente }) =>
{
  ...
  return (
    <div className="md:w-1/2 lg:w-2/5">
      ...
      >
        {error && <Error><p>Todos los campos deben llenarse</p></Error>}
        ...
        <div className="mt-7">
          ...
          <input
            type="submit"
            className="bg-indigo-600 w-full p-3 text-white uppercase rounded-md font-bold mt-2 hover:bg-indigo-700 cursor-pointer transition-all"
